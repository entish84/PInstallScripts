...
plugins=(aliases copyfile starship web-search fzf zsh-autosuggestions zsh-autocomplete zsh-history-substring-search zsh-syntax-highlighting)
...
alias q="exit"
alias n="nvim"
alias nt="nvim ~/.config/nvim/init.lua"
